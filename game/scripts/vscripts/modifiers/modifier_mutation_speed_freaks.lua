modifier_mutation_speed_freaks = modifier_mutation_speed_freaks or class({})
...
function modifier_mutation_speed_freaks:GetModifierMoveSpeed_Limit()
	return self.max_movespeed
end

function modifier_mutation_speed_freaks:GetModifierIgnoreMovespeedLimit()
	return 1
end
