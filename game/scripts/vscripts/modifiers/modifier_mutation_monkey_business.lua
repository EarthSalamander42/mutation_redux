...
LinkLuaModifier("modifier_mutation_monkey_business_transform", "modifiers/modifier_mutation_monkey_business.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mutation_monkey_business_transform_extra", "modifiers/modifier_mutation_monkey_business.lua", LUA_MODIFIER_MOTION_NONE)
