LinkLuaModifier("modifier_thinker_call_down", "modifiers/modifier_mutation_call_down.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_thinker_call_down_second", "modifiers/modifier_mutation_call_down.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_call_down_slow", "modifiers/modifier_mutation_call_down.lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_call_down_slow:GetTexture() return "gyrocopter_call_down" end
